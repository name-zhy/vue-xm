<template>
    <div class="page">
        <mt-swipe :auto="4000">
            <mt-swipe-item v-for="(v,i) in arrt" :key="i">
                <img :src="v.img" alt="">
            </mt-swipe-item>
        </mt-swipe>
    ...
    <div class="mui-content">
		        <ul class="mui-table-view mui-grid-view mui-grid-9">
		            ...
		            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to = "/pictures">
		            ...
		            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to = "/">
		                    ...
		                    <div class="mui-media-body">视屏专区</div></router-link></li>
		            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to = "/">
